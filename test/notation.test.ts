import { encodeFEN, decodeFEN, encodeMove, decodeMove } from '../src/utils/notation'
import type { Board, GameState, Move, Player } from '../src/types'
...
describe('PGN-like move notation', () => {
  ...
  it('should throw an error if coordinates are not valid numbers', () => {
    ...
    expect(() => decodeMove(invalidPGN)).toThrow('Invalid number in coordinates')
  })
